...
#
#
# new_road = Road(18000, 16)
# print(new_road.road_weight(), 'тонн')
...
#
#
# employee = Position('Nikolay', 'Nikolaev', 'Junior', {'wage': 44000, 'bonus': 44000})
...
#
#     def go(self):
#         print('{} Start going'.format(self.name))
#
#     def stop(self):
...
# sport_car = SportCar(325, 'Серая', 'Спортивная машина', False)
# work_car = WorkCar(90, 'Белая', 'Рабочая машина', False)
# police_car = PoliceCar(180, 'Черно-белая', 'Полицейская машина', True)
#
# town_car.show_speed()
...
class Pen(Stationery):
    def draw(self):
        print('Закончились чернила')


class Pencil(Stationery):
    def draw(self):
        print("Началась штриховка")
